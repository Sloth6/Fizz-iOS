//
//  BCNManageFriendsViewController.m
//  Fizz
//
...
@interface BCNManageFriendsViewController ()
...
@implementation BCNManageFriendsViewController
...
- (id)initWithStyle:(UITableViewStyle)style
{
    ...
    if (self) {
        ...
        UINib *nib = [UINib nibWithNibName:@"BCNManageFriendCell" bundle:nil];
...
- (BCNUser *)getFriendForIndexPath:(NSIndexPath *)indexPath{
    return [_friends objectAtIndex:indexPath.row];
}

- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    BCNUser *user = [self getFriendForIndexPath:indexPath];
    
    if([_friendsToRemove containsObject:user]){
        NSLog(@"Friends");
        [_friendsToRemove removeObject:user];
        
        BCNManageFriendCell *cell = (BCNManageFriendCell *)[tableView cellForRowAtIndexPath:indexPath];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    BCNManageFriendCell *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier forIndexPath:indexPath];
    
    BCNUser *user = [_friends objectAtIndex:indexPath.row];
