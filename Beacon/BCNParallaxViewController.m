...
#import "BCNParallaxCell.h"
#import "BCNAppDelegate.h"
#import "BCNParallaxTableView.h"

static float cellHeight;
static float parallaxOffset;

@interface BCNParallaxViewController ()
...
@implementation BCNParallaxViewController
...
- (id)initWithStyle:(UITableViewStyle)style
{
    ...
    if (self) {
        ...
        self.tableView = [[BCNParallaxTableView alloc] initWithFrame:frame style:style];
...
//        [self.tableView setSeparatorColor:[UIColor clearColor]];
        ...
        parallaxOffset = [BCNParallaxCell parallaxOffset];
        ...
        [self.tableView registerClass:[BCNParallaxCell class] forCellReuseIdentifier:@"pCell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    BCNParallaxCell *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier forIndexPath:indexPath];
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary *)change context:(void *)context
{
    ...
    if([object isKindOfClass:[UICollectionView class]] && [keyPath isEqualToString:@"contentOffset"])
    {
        ...
        self.tableView.contentOffset = scaledOffsetPoint;
...
//            progress = fmodf(progress, 1.0);
            ...
            BCNParallaxCell *cell = (BCNParallaxCell *)[self.tableView cellForRowAtIndexPath:indexPath];
