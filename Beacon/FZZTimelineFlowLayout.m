...
/*
 ...
 Unused for now, replaced by FZZScrollViewController

*/



#import "FZZTimelineFlowLayout.h"
#import "FZZCellFlowLayout.h"

static NSString * const FZZCellKind = @"Cell";
static int SECTION_DIVIDER_HEIGHT = 10;

@interface FZZTimelineFlowLayout ()
...
@implementation FZZTimelineFlowLayout
...
-(void)prepareLayout{
    ...
    newLayoutInfo[FZZCellKind] = cellLayoutInfo;
...
-(CGSize)collectionViewContentSize{
    int rows = [self.layoutInfo[FZZCellKind] count];
...
{
    return self.layoutInfo[FZZCellKind][indexPath];
}

- (CGRect)frameForCellAtIndexPath:(NSIndexPath *)indexPath
{
    NSNumber *rowNum = self.layoutInfo[FZZCellKind][indexPath][@"row"];
