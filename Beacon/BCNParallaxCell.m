...
#import "BCNTimelineEventCell.h"

static const float kPixelShown = 40;
static CGRect textRect;
static BOOL preparedClass = NO;

@interface BCNParallaxCell ()

@end

@implementation BCNParallaxCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        BCNTimelineEventCell *timelineCell = [[BCNTimelineEventCell alloc] init];
...
//    if (progress < 0) progress += 1;
    ...
    float cellY = [UIScreen mainScreen].bounds.size.height - (2*[BCNParallaxCell parallaxOffset]);
