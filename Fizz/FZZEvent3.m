...
//    self = [super init];
//    
////    self = (FZZEvent3 *)[FZZDataStore insertNewObjectForEntityForName:@"FZZEvent3"];
//    
//    if (self){
...
//}
//
//+(FZZEvent3 *)eventWithEID:(NSNumber *)eID{
//    if (!eID) return NULL;
//    
//    FZZEvent3 *event = [events objectForKey:eID];
//    
//    if (event == NULL){
//        event = [[FZZEvent3 alloc] initWithEID:eID];
//    }
//    
//    return event;
//}
...
////    if ([self.numSeats isEqualToNumber:_pendingNumSeats]){
////        return;
////    }
////    
////    self.numSeats = _pendingNumSeats;
////    
...
////}
//
//+(FZZEvent3 *)parseJSON:(NSDictionary *)eventJSON{
//    if (eventJSON == NULL){
//        return NULL;
//    }
//    
...
//    FZZEvent3 *event = [FZZEvent3 eventWithEID:eid];
...
//        FZZEvent3 *event = [FZZEvent3 parseJSON:eventJSON];
