...
//    self.burgerButton.frame = [FZZEventStreamViewController makeBurgerButtonFrame];//CGRectMake(4, 10 + 4, 60, 40);
//    
...
-(void)setCollectionView:(UICollectionView *)cv{
    [cv registerClass:[FZZEventCell class] forCellWithReuseIdentifier:@"OverviewCell"];
}
