...
#import "FZZEventDetailViewDelegate.h"
...
@interface FZZEventDetailViewDelegate ()
...
@implementation FZZEventDetailViewDelegate
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    FZZMessage *message = [[_event messages] objectAtIndex:index];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)cv cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    FZZDetailTextCell *cell = [cv dequeueReusableCellWithReuseIdentifier:cellID
    ...
    [user fetchProfilePictureIfNeededWithCompletionHandler:^(UIImage *image) {
        if (image != NULL){
            ...
            [FZZUser formatImageViewToCircular:cell.imageView forRect:cell.imageView.frame];
//            [FZZUser formatImageViewToCircular:cell.imageView withScalar:1.0];
        }
    }];
